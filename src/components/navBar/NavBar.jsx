                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <Disclosure.Button
                                                className="relative inline-flex items-center justify-center rounded-md p-2 text-gray-900 border-solid border-2 border-gray-500 focus:outline-none">
                                                <span
                                        ...
                                        <div
                                            ...
                                            <div
                                                className="hidden sm:ml-6 sm:block m-3">
                                                        ...
                                                        <div className="flex space-x-4">
                                                            {navigationConnexion.map((item) => (
                                                                <Link
                                                                    key={item.name}
                                                                    to={item.to}
                                                                    className={`text-gray-900 rounded-md px-3 py-2 text-sm font-medium ${item.current ? 'bg-gray-200' : ''}`}
                                                                ...
                                                                <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                                                    <Menu.Item>
                                                                        {({ active }) => (
                                                                            <div
                                                                                ...
                                                                                className="block bg-red-800 flex justify-center text-amber-50 px-4 py-2 text-sm ">
                                                                                {user.firstName}
                                                                            </div>
                                                                        )}
                                                                    </Menu.Item>
                                                                    ...
                                                                    <Menu.Item>
                                                                        {({ active }) => (
                                                                            <button
                                                                                onClick={SignOut}
                                                                                className={`${active ? 'bg-gray-100' : ''} block px-4 py-2 text-sm text-red-700`}
                                                                            >
                                                                                Se déconnecter
                                                                            </button>
                                                                        )}
